...
public class SocketHandler implements WebSocketHandler{
  ...
  public void handleMessage(WebSocketSession arg0, WebSocketMessage<?> arg1)
    ...
    // TODO Auto-generated method stub
	  ...
	  String TagName=arg1.getPayload().toString();
	  WriteData jsonArray = new Gson().fromJson(TagName, WriteData.class);
	  Client.funcAsyncWrite(jsonArray.getTagName(), jsonArray.getValue(),jsonArray.getType());
